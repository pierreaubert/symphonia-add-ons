...
#[inline]
pub(super) fn ac_get_ptable_index(predict: i16, ptable_len: i32) -> i32 {
    let abs = predict.unsigned_abs() as i32;
    let j = abs >> consts::AC_QSTEP;
    if j >= ptable_len { ptable_len - 1 } else { j }
}

pub(super) const REVERSE7: [i16; 128] = [
...
pub(super) fn reverse7_lsbs(c: i16) -> i32 {
    REVERSE7[((c as i32 + (1 << consts::SIZE_PREDCOEF)) & 127) as usize] as i32
}

pub(super) fn log2_round_up(x: u32) -> usize {
